...
const Hero = () => {
  return (
    <div className= 'relitive md:h-[480px] h-[550px]  w-full rounded-bl-[120px]  bg-gradient-to-tl from-red-500 via-red-400 to-red-300'>
        ...
        <div className='  w-full h-full  flex flex-col justify-center items-center text-white'>
            <div className='flex flex-col mt-[50px] md:mt-[180px] md:left-[10%] text-center justify-center items-center max-w-[1100px] m-auto  p-4'>
                <h1 className='flex mt-[110px] md:mt-0 text-3xl md:text-[45px] font-semibold md:2xl drop-shadow-2xl'>A modern <br className='sm:hidden'/> publishing platform</h1>
